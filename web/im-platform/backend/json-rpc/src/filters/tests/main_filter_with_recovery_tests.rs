...
async fn get_good_thing(params: Option<Params>, auth: Option<String>) -> Result<GoodThing, Error> {
    match params {
...
async fn get_bad_thing(_params: Option<Params>, auth: Option<String>) -> Result<BadThing, Error> {
    Ok(BadThing)
}
